...
//        chucNangOHomeArrayList.add(new ChucNangOHome("Thêm bệnh nhân", R.drawable.icons_person_add));
        chucNangOHomeArrayList.add(new ChucNangOHome("Quản lý bệnh nhân", R.drawable.icons_edit)); // sửa bệnh nhân
//        chucNangOHomeArrayList.add(new ChucNangOHome("Xóa bệnh nhân", R.drawable.icons_person_delete));
        ...
        chucNangOHomeArrayList.add(new ChucNangOHome("Quản lý cơ sở y tế", R.drawable.icons_hospital)); // thêm cơ sở y tế
...
//                System.out.println();
                switch (i){
                    case 0:
                        Intent intent = new Intent(HomeActivity.this, TXSbenhNhan.class); //ThemBenhNhanActivity
                        startActivity(intent);
                        break;
                    case 1:
                        intent = new Intent(HomeActivity.this, TraCuuBenhNhanActivity.class); //SuaBenhNhanActivity
                        startActivity(intent);
                        break;
                    case 2:
                        intent = new Intent(HomeActivity.this, TXScoSoYTe.class); //XoaBenhNhanActivity
                        startActivity(intent);
                        break;
//                    case 3:
